        ...
        <div className="w-full px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-4 min-w-0">
              <div className="gradient-primary p-3 rounded-2xl shadow-glass transform hover:scale-105 transition-smooth" role="img" aria-label="EduWatch Logo">
                <GraduationCap className="w-7 h-7 text-white" aria-hidden="true" />
              </div>
            </div>

            {/* Main Navigation - Center Section */}
            <nav className="hidden lg:flex items-center space-x-2 bg-opacity-50 rounded-2xl p-2" 
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${activeView === item.id ? 'font-semibold shadow-lg scale-105' : 'hover:shadow-md'}
                    `}
                    style={{
            ...
            {user && (
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2 bg-opacity-50 rounded-xl p-1" 
                  ...
                  {/* Export */}
                  <button
                    className="flex items-center space-x-1 px-3 py-2 rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2"
                    style={{ 
